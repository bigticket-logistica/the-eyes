...
import { encolarAudio } from "../shared/mensajes-pnr.js";
...
export default function GrabadorAudioPnr({ telefono, caseId, conversacionId, disabled, onEnviado }) {
  ...
  async function enviar() {
    ...
    try {
      // Se sube el archivo crudo y se deja encolado. La conversión de WebM a
      // ogg-opus la hace el worker pnr-enviar con ffmpeg: WhatsApp no acepta
      // WebM, y Chrome —que es lo que usan las analistas por la extensión Don
      // B— graba justo en ese formato.
      await encolarAudio({
        blob: grabacion.blob, mime: grabacion.mime,
        conversacionId, telefono, caseId,
      });
