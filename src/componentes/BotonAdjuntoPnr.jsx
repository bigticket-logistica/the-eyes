...
import { encolarAdjunto, validarAdjunto, tipoDeArchivo } from "../shared/mensajes-pnr.js";

// ═══════════════════════════════════════════════════════════════════════════
// Botón 📎 del compositor del canal de Posventa. Sube el archivo al bucket
// privado y lo deja en la cola; el worker pnr-enviar.cjs lo manda.
//
// Copia de BotonAdjunto.jsx con un cambio: en vez de invocar la Edge Function
// whatsapp-media, inserta la fila encolada. El resto —la validación previa, la
// vista previa, el diálogo— se conserva tal cual.
//
...
export default function BotonAdjuntoPnr({ telefono, caseId, conversacionId, disabled, onEnviado }) {
