...
function BurbujaConHora({ m }) {
  // La hora se le PASA a la burbuja en vez de dibujarse encima. Antes iba en un
  // recuadro opaco superpuesto para tapar la que trae el componente, y el truco
  // se notaba: si el texto de abajo era más ancho o el fondo no calzaba con el
  // de la burbuja, quedaban las dos fechas encimadas.
  return (
    <BurbujaPnr m={m} horaTexto={`${hora(m.creado_en)} CDMX`} />
  );
}
